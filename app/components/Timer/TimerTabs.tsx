      ...
      {tabs.map(({ id, label }) => {
        ...
        return (
          <button
            ...
            className={`flex-1 px-2 sm:px-3 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg sm:rounded-xl text-[10px] sm:text-xs lg:text-sm font-medium transition-all duration-300 ${
              timerMode === id
